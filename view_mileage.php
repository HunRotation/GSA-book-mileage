...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    b.author as author, b.publisher as publisher, r.date as date, r.status as status from read_record r, book_list b
    where r.code=b.code and r.id=".$_GET['id'];
...
<table class="table table-bordered table-striped">
  ...
  if ($sno == 'admin') {
    ...
    echo '
    <div class="row">
      <form action="delete_mileage.php" method="post">
